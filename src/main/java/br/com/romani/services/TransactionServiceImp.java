...
public class TransactionServiceImp implements TransactionService {
    ...
    private final TransactionTypeServiceImp transactionTypeService;

    @Autowired
    public TransactionServiceImp(TransactionRepositorie transactionRepositorie,
    ...
    public Transaction getEntityBy(TransactionDto dto) {
